...
`,Mt=c.h3(({theme:e})=>{const{desktop:t}=y;return f`
  ...
  border-radius: 5px;
`,Ie=({children:e})=>o.jsx(Vt,{children:e}),Nt=({movie:e})=>{const t=st(),{userId:s,library:i,isLoggedIn:n}=at(),v=Pe(e.genre_ids).join(" "),b=!!i.find(a=>a.id===e.id),C=()=>{if(n&&s){t(dt({userId:s,movie:e,action:b?"remove":"add"}));return}console.log("you are not logged in")};return o.jsxs(_t,{children:[o.jsx(kt,{src:`https://image.tmdb.org/t/p/original/${e.poster_path}`}),o.jsxs("div",{children:[o.jsx(St,{children:e.title}),o.jsxs(Lt,{children:[o.jsxs(F,{children:[o.jsx(L,{color:"grey",children:"Vote / Votes"}),o.jsxs(L,{color:"grey",children:[o.jsx(Ie,{children:e.vote_average.toFixed(1)})," /"," ",o.jsx(Ie,{children:e.vote_count})]})]}),o.jsxs(F,{children:[o.jsx(L,{color:"grey",children:"Popularity"}),o.jsx(L,{color:"white",children:e.popularity.toFixed(1)})]}),o.jsxs(F,{children:[o.jsx(L,{color:"grey",children:"Genre"}),o.jsx(L,{color:"white",children:v})]})]}),o.jsx(Mt,{children:"About"}),o.jsx($t,{children:e.overview}),o.jsx(lt,{$isBordered:!0,onClick:C,children:b?"Remove from library":"Add to library"})]})]})};export{Nt as M,Ae as R,Ct as S,Ie as V,Gt as a,Pt as b,At as c,zt as d,bt as e,ct as s,Pe as u};
